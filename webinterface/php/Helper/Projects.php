...
class Projects
{
    ...
    public function listProjects()
    {
        ...
        if ($this->getNumberOfProjects() === 0) {
            ...
            $pages = array();
            $root = substr(WPNXM_ROOT,0,-1);
            foreach ($this->projectFolders as $projectFolder){
                array_push($pages,array('href'=>$root.'/'.$projectFolder,'project'=>$projectFolder));
            }
//            array_push($pages,array('href'=>$root.':8001','project'=>'gestionusuarios'));
//            array_push($pages,array('href'=>$root.':8002','project'=>'firestore'));
//            array_push($pages,array('href'=>$root.':8003','project'=>'licencias'));
//            array_push($pages,array('href'=>$root.':8004','project'=>'jemanup'));
//            array_push($pages,array('href'=>$root.':8005','project'=>'vuexy'));
//            array_push($pages,array('href'=>$root.':8006','project'=>'sivitec'));
//            array_push($pages,array('href'=>$root.':8007','project'=>'simulador'));
//            array_push($pages,array('href'=>$root.':8008','project'=>'sistemaVentas1'));
//            array_push($pages,array('href'=>$root.':8009','project'=>'sistemaVentas2'));
//            array_push($pages,array('href'=>$root.':8010','project'=>'gestionusuarios_v2'));
            array_push($pages,array('href'=>$root.':8011','project'=>'Livewire'));
//            array_push($pages,array('href'=>$root.':9000','project'=>'siarhu_v2'));

            foreach ($pages as $dir) {
                // always display the folder
                $html .= '<li class="list-group-item">';
                $html .= '<a class="folder" href="' . $dir['href'] . '">' . $dir['project'] . '</a>';

                if (FEATURE_4 == true) {
                    $html .= $this->renderSettingsLink($dir['href']);
                }

                $html .= $this->renderRepositoryLinks($dir['href']);
